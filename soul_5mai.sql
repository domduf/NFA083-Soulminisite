...
--
-- Client: localhost
-- Généré le: Mer 25 Mai 2016 à 17:55
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `contact_telephone` char(10) NOT NULL,
...
INSERT INTO `contact` (`contact_id`, `contact_nom`, `contact_prenom`, `contact_email`, `contact_telephone`, `contact_objet`, `contact_message`, `contact_dateTime`) VALUES
(1, 'Dufour', 'Dominique', 'dom.duf@mail.fr', '123456789', '2', 'salut au site, super exemple, continuez.', '0000-00-00 00:00:00'),
(2, 'DUFOUR', 'dominique', 'dom.duf@gmail.fr', '238758366', '0', 'am&eacute;liorer le format du t&eacute;l&eacute;phone, SVP...', '0000-00-00 00:00:00'),
(3, 'THOUVENIN', 'Sophie', 'dom.duf@gmail.fr', '238758367', '0', 'L&agrave; j''ai mis un (string) avant ', '0000-00-00 00:00:00'),
(4, 'THOUVENIN', 'Sophie', 'dom.duf@gmail.fr', '0238758368', 'amelioration', 'c''est fait ', '0000-00-00 00:00:00'),
(5, 'BOLEMBIAIS', 'Guy', 'guy.bolembiais@gmal.can', '0235689512', 'contact', 'l&agrave; j''ai mis la page musicos, mais y''a encore un max de taf sur ce p..tain de site', '0000-00-00 00:00:00'),
(25, 'DUFOUR', 'Jean', 'yenai.pas@demail.com', '0238910710', 'contact', 'il est b&ocirc; ton site mon filiales', '2016-05-24 16:58:04'),
(7, 'DUFOUR', 'Dominique', 'dom.duf@gmail.fr', '0123456789', 'information', 'hellooooo !!!!', '0000-00-00 00:00:00'),
(8, 'DUFOUR', 'Dominique', 'dom.duf@gmail.fr', '0123456789', 'information', 'saalut', '0000-00-00 00:00:00'),
(9, '&lt;H1&gt;salut&lt;/H1&gt;', '', '', '', 'contact', '', '0000-00-00 00:00:00'),
(10, 'LIKE &#039;\\%-hello&#039;', '', '', '', 'contact', '', '0000-00-00 00:00:00'),
(11, 'LIKE &#039;\\%\\_hello&#039;&lt;', '', '', '', 'contact', '', '0000-00-00 00:00:00'),
(12, 'DUFOUR', 'Dominique', 'dom.duf@gmail.fr', '0123456789', 'amelioration', 'il y a un probleme avec 1and1 au niveau des variables \\_SESSION et je ne sais pas ce que sont ces probl&egrave;mes...\r\n', '0000-00-00 00:00:00'),
(13, 'DUFOUR', 'Fabien', 'leonarduf@gmail.com', '0783432657', 'amelioration', 'METTRE DES FLEURS\r\nSINON C EST SUPER\r\n\r\nFABIEN', '0000-00-00 00:00:00'),
(17, 'Dufour', '', '', '', 'contact', 'essai Datetime', '2016-05-24 17:46:03'),
(20, 'THOUVENIN', 'Sophie', 'dom.duf@gmail.cum', '0663456342', 'amelioration', 'oui, c cool ce site, j''adoore et qu''il est eau le Dominique avec son grand trombone...', '2016-05-24 18:00:39'),
(21, 'FIPOUNET', 'Barbara', 'barb.fripoun@wana.com', '0663456342', 'information', 'tu peux me dire la date du concert stp ?', '2016-05-24 18:04:57'),
(24, 'DUFOUR', 'Dominique', 'dom.duf@gmail.cum', '0663342821', 'information', 'juste pour voir si la maj de la bd marche', '2016-05-24 16:32:24'),
(26, 'DUFOUR', 'jean', 'yen.a@pas.fr', '0663342821', 'contact', 'suuper', '2016-05-24 17:05:33'),
(27, 'DUFOUR', 'Dominique', 'dom.duf@gmail.fr', '0663342821', 'information', 'preuve F076', '2016-05-24 17:26:31'),
(28, 'DUFOUR', 'Dominique', 'dom.duf@gmail.fr', '0663342821', 'contact', 'preuve 078\r\n', '2016-05-24 18:50:38'),
(29, 'GRIGOU', 'Jeanot', 'j.grig@wana.org', '0663342821', 'contact', 'salut, votre site est naze, et il sera jamais fini.\r\nDepuis le temps qu''on l''attend, le groupe est s&eacute;par&eacute;, le bassiste &agrave; p&eacute;t&eacute; la tronche du batteur, le tromboniste a', '2016-05-25 05:44:36'),
(30, 'DUF_OUR', 'Domduf', 'dom.duf@gmail.fr', '0663342821', 'contact', 'test pour search console', '2016-05-25 14:48:32');
...
CREATE TABLE IF NOT EXISTS `jouer` (
  ...
  PRIMARY KEY (`mem_id`,`inst_id`),
  KEY `FK_jouer_inst_id` (`inst_id`)
...
(4, 'stfgim', NULL, 'Internaute', 'oui', 'le plus souple', 'M.', 'Gimonet', 'Stephane', NULL, 'masculin', NULL, 'Stéphane, dit "Mister Lips" est le pointeur (celui qui joue dans l''aigü) de la section de cuivre.\r\nD''une formation informatique, il a préféré  garder la musique comme activité secondaire, mais ses capacités sont terribles !', './images/musicos/StfG.jpg', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'philippe', 'Phil-1234', 'Gestionaire', 'non', NULL, 'M.', 'Bouquet', 'Philippe', NULL, 'masculin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'hery', 'Hery-1234', 'Gestionaire', 'non', NULL, 'M.', 'Ratsimbasafy', 'Hery', NULL, 'masculin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
