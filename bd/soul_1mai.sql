...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 12 Mai 2016 à 16:59
...
(1, 'domduf', 'Dom-2016', 'Gestionaire', 'oui', 'M.', 'Dufour', 'Dominique', '1967-03-26', 'masculin', NULL, 'Dominique est un tromboniste formé au conservatoire d''Orléans par Monsieur Alain Recordier.', './images/musicos/Dom.jpg', NULL, 'dom.duf@coucou.com', 5, 'rue de la Motte', '45170', 'NEUVILLE AUX BOIS'),
...
(5, 'philippe', 'Phil-2016', 'Gestionaire', 'non', 'M.', 'Bouquet', 'Philippe', NULL, 'masculin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'hery', 'Hery-2016', 'Gestionaire', 'non', 'M.', 'Ratsimbasafy', 'Hery', NULL, 'masculin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
