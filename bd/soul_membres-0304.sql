...
--
-- Client :  localhost
-- Généré le :  Dim 03 Avril 2016 à 09:31
...
CREATE TABLE `se_connecter` (
  `se_connecter_mdp` char(255) NOT NULL,
  `mem_id` char(12) NOT NULL,
  `acces_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('$2y$10$63XupYzw0pyAyhwRudBxzOZ06EZfM5paEKq.WhecyFjMeigtpo6sW', 'domduf', 2),
('$2y$10$63XupYzw0pyAyhwRudBxzOZ06EZfM5paEKq.WhecyFjMeigtpo6sW', 'domduf', 3),
('$2y$10$63XupYzw0pyAyhwRudBxzOZ06EZfM5paEKq.WhecyFjMeigtpo6sW', 'domduf', 4),
('$2y$10$63XupYzw0pyAyhwRudBxzOZ06EZfM5paEKq.WhecyFjMeigtpo6sW', 'domduf', 5),
('$2y$10$tqAD21bN/7WvwRnc/J6wROWzUOmxcbl.Bmfg0xggfLIPLI/DcI0ZO', 'herylala', 2),
('$2y$10$tqAD21bN/7WvwRnc/J6wROWzUOmxcbl.Bmfg0xggfLIPLI/DcI0ZO', 'herylala', 3),
('$2y$10$tqAD21bN/7WvwRnc/J6wROWzUOmxcbl.Bmfg0xggfLIPLI/DcI0ZO', 'herylala', 4),
('$2y$10$ssn6CXESFNJdBwWpSv5t/uXEDMmutDHd/9J.U5M8hDRfrm29pl4hi', 'philippe', 4);
